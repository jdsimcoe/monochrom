" Monochrom color scheme for Vim
"
" Name:       monochrom.vim
" Maintainer: Jonathan Simcoe <jdsimcoe@users.noreply.github.com>
" License:    MIT
...
let g:colors_name = 'monochrom'

let s:white  = ['White', 15]
let s:black  = ['#151515', 16]
let s:bgray  = ['#151515', 233]
let s:lgray  = ['LightGray', 255]
let s:cgray  = ['#767676', 243]
let s:dgray  = ['DarkGray', 248]
let s:sblue  = ['#626262', 241]
let s:yellow = ['#4e4e4e', 239]
let s:red    = ['#b2b2b2', 249]
let s:green  = ['#767676', 243]
